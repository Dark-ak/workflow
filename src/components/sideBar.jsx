...
const SideBar = () => {
    ...
    return (
        <div className=''>
            <aside className=''>
                <div className={`ml-5 lg:mx-10 min-w-[120px] lg:w-[300px] ${isSidebar ? "max-h-[100vh] lg:pb-10" : "max-h-[40px] lg:max-h-[60px]"} transition-all duration-500 overflow-hidden bg-white rounded-md px-4 py-2 border-2 border-gray-200 ease-out`}>
                    <div className='flex items-center justify-between cursor-pointer lg:px-3 lg:py-1 rounded hover:bg-gray-200' onClick={() => setSidebar(!isSidebar)}>
                    ...
                    <div className={`flex-col items-center gap-12 mx-2 hidden mt-4 lg:flex`}>
                        ...
                        <div className='min-w-32 min-h-14 rounded border bg-orange-200 border-orange-500 text-white flex items-center justify-center shadow' onDragStart={(event) => handleDragStart(event, "out")} draggable>
                            <p>Output</p>
                        </div>

                        <div className="w-[100px] h-[100px] -rotate-45 bg-yellow-200 border-yellow-500 border text-white flex items-center justify-center" onDragStart={(event) => handleDragStart(event, "decision")} draggable>
